...
namespace Febucci.UI.Effects
{
    ...
    [CreateAssetMenu(fileName = "Size Appearance", menuName = "Text Animator/Animations/Appearances/SizeCurved")]
    [EffectInfo("size", EffectCategory.Appearances)]
    public sealed class SizeAppearanceCurve : AppearanceScriptableBase
    {
        float amplitude;
        ...
        public override void ApplyEffectTo(ref Core.CharacterData character, TAnimCore animator)
        {
            character.current.positions.LerpUnclamped(
                ...
                AnimationCurve.Evaluate(1 - (character.passedTime / duration)) * amplitude
                );
        }
