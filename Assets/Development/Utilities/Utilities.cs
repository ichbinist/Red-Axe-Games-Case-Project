...
namespace GuardAndGarden
{
    public static class Utilities
    {
        public static void DelayedCall(Action e, float duration)
        {
            StaticCoroutine.Start(Wait(duration, e));
        }

        private static IEnumerator Wait(float duration, Action e)
        {
    ...
    public class StaticCoroutine : MonoBehaviour
    {
        ...
        private static StaticCoroutine Build()
        {
            ...
            instanceObject.transform.parent = LoadingScreenManager.Instance.transform;
            instanceObject.transform.parent = null;
